...
import { CircularProgress, Container, Typography, Card, CardHeader, CardContent, List, ListItem, ListItemAvatar, ListItemText, Box, Chip, Drawer, IconButton, Button, Dialog, DialogTitle, DialogActions, DialogContent, Accordion, AccordionDetails, AccordionSummary, Divider, ListItemIcon, Backdrop, Skeleton } from "@mui/material";
...
const ListDetail: React.FC = () => {
    ...
    const isDataReady = !isLoadingListItems && listItems?.list_items.active !== undefined;

    return (
        <>
            <Header
                title="You have..."
                subTitle={!isDataReady ? <Skeleton variant="text" width={200} height={32} /> : `${listItems?.list_items.active.length} active list items`}
            />
            ...
            <Backdrop sx={{ color: '#fff', zIndex: (theme) => theme.zIndex.drawer + 1 }} open={isLoadingList || isLoadingListItems}>
